    ...
    function SkillPage({ sessionId, pickDirectory }) {
      ...
      return React.createElement("div", { className: "cm-page" },
        React.createElement("div", { className: "cm-head" },
          ...
          React.createElement("button", { className: "cm-btn primary", onClick: doImport, disabled: importing, "aria-busy": importing, title: "选择包含 SKILL.md 的目录，完整复制到 ~/.dsh/skills" }, React.createElement(React.Fragment, null, React.createElement(IconPlusOutline16, { size: 14 }), "导入 Skill")),
        ),
...
// src/client/index.jsx
var inject = ["slots", "locale", "connection", "uiWorkspace"];
...
function SkillPanel({ panel, t, sessionId, pickDirectory }) {
  ...
  return import_react2.default.createElement(
    ...
    import_react2.default.createElement(panel.SkillPage, { sessionId, pickDirectory })
  );
}
function ManagerBody({ entryId, panels, rpc, automationT, permissionT, modelT, t, onClose, sessionId, pickDirectory }) {
  ...
  if (entryId === "skill" && panels.skillMcp !== void 0) {
    return import_react2.default.createElement(SkillPanel, { panel: panels.skillMcp, t, sessionId, pickDirectory });
  }
